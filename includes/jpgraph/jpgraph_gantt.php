...
// Ver:		$Id: jpgraph_gantt.php,v 1.1 2004/08/25 01:12:53 rboyleiii Exp $
//
...
class GanttActivityInfo
{
    ...
    public function GetColStart($aImg, &$ioStart, $aAddLeftMargin = false)
    {
        $n = count($this->iTitles);

        $adj = $aAddLeftMargin ? $this->iLeftColMargin : 0;

        $ioStart = [$aImg->left_margin + $adj];
...
class GanttGraph extends Graph
{
    ...
    public $iSimpleFont         = FF_FONT1;
    public $iSimpleFontSize = 11;
    public $iSimpleStyle = GANTT_RDIAG;
    public $iSimpleColor = 'yellow';
    public $iSimpleBkgColor = 'red';
    public $iSimpleProgressBkgColor = 'gray';
    public $iSimpleProgressColor = 'darkgreen';
    ...
    public function Add($aObject)
    {
        if (is_array($aObject) && count($aObject) > 0) {
            ...
            if ('iconplot' == $cl) {
                ...
                for ($i = 0, $iMax = count($aObject); $i < $iMax; ++$i) {
                    $this->iObj[] = $aObject[$i];
                }
            }
        } else {
    ...
    public function GetMaxLabelWidth()
    {
        ...
        if (null != $this->iObj) {
            ...
            for ($i = 1, $iMax = count($this->iObj); $i < $iMax; ++$i) {
...
class TextProperty
{
    ...
    public function SetCSIMTarget($aTarget, $aAltText = '')
    {
...
class GanttScale
{
    ...
    public $iImg;
    public $iTableHeaderBackgroundColor = 'white';
    public $iTableHeaderFrameColor = 'black';
    public $iTableHeaderFrameWeight = 1;
    public $iAvailableHeight = -1;
    public $iVertSpacing = -1;
    ...
    public function GetWeekNbr($aDate)
    {
        ...
        if ($this->day->iShowLabels) {
            ...
            for ($i = 0; $i < $this->GetNumberOfDays(); ++$i, $x += $daywidth, $day += 1, $day %= 7) {
                ...
                switch ($this->day->iStyle) {
                    ...
                    default:
                        // "M"
                        $txt = mb_substr(date('D', $datestamp), 0, 1);
                        break;
                }
...
class GanttPlotObject
{
    ...
    public function SetCSIMTarget($aTarget, $aAlt = '')
    {
        if (!is_string($aTarget)) {
...
class GanttBar extends GanttPlotObject
{
    ...
    public $iFillColor = 'white';
    public $iFrameColor = 'black';
    public $iShadow = false;
    public $iShadowColor = 'darkgray';
    public $iShadowWidth = 1;
    public $iShadowFrame = 'black';
    public $iPattern = GANTT_RDIAG;
    public $iPatternColor = 'blue';
    public $iPatternDensity = 95;
    public $leftMark;
    public $rightMark;
    public $progress;
    //---------------
...
class TextPropertyBelow extends TextProperty
{
    ...
    public function GetColWidth($aImg, $margin)
    {
...
{
    public $iLine;
    public $title_margin = 3;
    public $iDayOffset = 1;
    // Defult to right edge of day

    //---------------

    // CONSTRUCTOR

    public function __construct($aDate, $aTitle = '', $aColor = 'black', $aWeight = 3, $aStyle = 'dashed')
    {
        parent::__construct();
...
class LinkArrow
{
    ...
    public $iDirection = ARROW_DOWN;
    public $iType = ARROWT_SOLID;
    public $iSize = ARROW_S2;
    public $iColor = 'black';
...
class GanttLink
{
    ...
    public $iy2;
    public $iPathType = 2;
    public $iPathExtend = 15;
    public $iColor = 'black';
    public $iWeight = 1;
    public $iArrowSize = ARROW_S2;
    public $iArrowType = ARROWT_SOLID;
