...
// Ver:		$Id: jpgraph_pie3d.php,v 1.1 2004/08/25 01:12:53 rboyleiii Exp $
//
...
{
    public $labelhintcolor = 'red';

    public $showlabelhint = true;

    public $labelmargin = 0.30;
    ...
    public function SetEdge($aColor, $aWeight = 1)
    {
    ...
    public function AddSliceToCSIM($i, $xc, $yc, $height, $width, $thick, $sa, $ea)
