...
// Ver:		$Id: jpgraph_polar.php,v 1.1 2004/08/25 01:12:53 rboyleiii Exp $
//
...
{
    public $angle_step = 15;

    public $angle_color = 'lightgray';

    public $angle_label_color = 'black';

    public $angle_fontfam = FF_FONT1;

    public $angle_fontstyle = FS_NORMAL;

    public $angle_fontsize = 10;

    public $angle_fontcolor = 'navy';

    public $gridminor_color = 'lightgray';

    public $gridmajor_color = 'lightgray';

    public $show_minor_grid = false;

    public $show_major_grid = true;

    public $show_angle_mark = true;

    public $show_angle_grid = true;

    public $show_angle_label = true;

    public $angle_tick_len = 3;

    public $angle_tick_len2 = 3;

    public $angle_tick_color = 'black';
...
class PolarScale extends LinearScale
{
    ...
    public function __construct($aMax, &$graph)
    {
...
class PolarGraph extends Graph
{
    ...
    public function SetScale($aScale, $rmax = 0)
    {
        if ('lin' == $aScale) {
