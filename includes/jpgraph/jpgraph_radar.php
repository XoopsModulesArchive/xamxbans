...
// Ver:		$Id: jpgraph_radar.php,v 1.1 2004/08/25 01:12:53 rboyleiii Exp $
//
    ...
    public function Stroke($aImg, &$grid, $aPos, $aAxisAngle, $aScale, &$aMajPos, &$aMajLabel)
    {
        ...
        for ($y = $start; $y <= $limit; $y += $step, ++$count) {
            ...
            if (0 == $count % 10) {
                ...
                $count = 1;
            } elseif (!$this->supress_minor_tickmarks) {
                if ('' != $this->mincolor) {
