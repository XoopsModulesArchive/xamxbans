...
// Ver:		$Id: jpgraph_stock.php,v 1.1 2004/08/25 01:12:53 rboyleiii Exp $
//
...
class StockPlot extends Plot
{
    ...
    public $iStockColor1 = 'white';

    public $iStockColor2 = 'darkred';

    public $iStockColor3 = 'darkred';
...
{
    public $iPColor = 'black';

    public $iNColor = 'white';
