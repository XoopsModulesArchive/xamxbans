...
$gametypelst = GetGametypeNames();
$tellertje = 0;
$nrofbanslst = [];

reset($gametypelst);

while (list($key, $val) = each($gametypelst)) {
    $nrofbanslst[$tellertje] = GetBansPerGametype($val);
...
//Gradients rule!
$bplot->SetFillGradient('darkblue', 'orange', GRAD_HOR);
